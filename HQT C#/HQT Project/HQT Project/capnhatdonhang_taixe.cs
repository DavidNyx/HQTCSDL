    ...
    public partial class capnhatdonhang_taixe : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" || comboBox1.SelectedItem != null || textBox2.Text != "")
                {//check ma don hang nhap vo
                    nachos.sqlCon.Open();
                    SqlDataAdapter adapt1 = new SqlDataAdapter("SELECT * from donhang where qtvc NOT LIKE N'Hoàn tất' and cmnd = '" + textBox2.Text + "' and madh = '" + textBox1.Text + "' ", nachos.sqlCon);
                    ...
                    else
                    {
                        ...
                        SqlDataAdapter adapt2 = new SqlDataAdapter("SELECT * FROM donhang WHERE qtvc = N'Đang giao hàng' and madh = '" + textBox1.Text + "' and cmnd = '" + textBox2.Text + "' ", nachos.sqlCon);
                        DataTable table2 = new DataTable();
                        adapt2.Fill(table2);
                        //check tinh trang la dang giao hang
                        SqlDataAdapter adapt3 = new SqlDataAdapter("SELECT * FROM donhang WHERE qtvc = N'Đã hoàn tất' and madh = '" + textBox1.Text + "' and cmnd = '" + textBox2.Text + "' ", nachos.sqlCon);
                        ...
                        else
                        {
                            ...
                            cmd = new SqlCommand("EXEC dbo.UPDATE_DONHANG '" + madh + "', N'" + value + "'" , nachos.sqlCon);
                            cmd.ExecuteNonQuery();
                            nachos.sqlCon.Close();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox2.Text != "")
                {
                    nachos.sqlCon.Open();
                    SqlDataAdapter adapt = new SqlDataAdapter("SELECT * from taixe where cmnd = '" + textBox2.Text + "' ", nachos.sqlCon);
                    ...
                    {
                        SqlDataAdapter adapt1 = new SqlDataAdapter("SELECT * FROM donhang WHERE qtvc NOT LIKE N'Hoàn tất' and cmnd = '" + textBox2.Text + "' ", nachos.sqlCon);
                        DataTable table1 = new DataTable();
                        adapt1.Fill(table1);
