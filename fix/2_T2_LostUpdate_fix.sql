...
BEGIN
	BEGIN TRAN
		...
		SET @SO_LUONG = (SELECT dbo.QUANLYKHO.SLSP FROM QUANLYKHO WITH(UPDLOCK) WHERE QUANLYKHO.MASP = @MASP AND QUANLYKHO.MACN = @MACN AND dbo.QUANLYKHO.MADOITAC = @MADT)
...
DROP PROCEDURE dbo.UPDATE_SOLUONG1