...
--thêm database bên dưới để test
--thời gian hiệu lực đã sửa thành date thay vì date time
INSERT dbo.HOPDONG
(
    MADOITAC,
    MATHUE,
...
VALUES
(   'DT0000000001',   -- MADOITAC - char(12)
    'MT0000000004',   -- MATHUE - char(12)
    1, -- SOCNDK - int
    '2020-01-01', -- TGHIEULUC - date
    5, -- PHANTRAMHOAHONG - float
    500000 -- PHIHOAHONG - float
    )
...
VALUES
(   'KH0000000003',   -- MAKH - char(12)
    N'Ngyễn Q', -- HOTENKH - nvarchar(50)
    '0000000000', -- SDTKH - char(10)
    N'1, Ngyễn Trãi, quận 4, HCM', -- DIACHIKH - nvarchar(100)
    'q@gmail.com'  -- EMAILKH - varchar(50)
    )
