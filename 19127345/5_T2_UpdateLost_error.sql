...
BEGIN
	...
	DECLARE @TONKHO INT
	SET @TONKHO = (SELECT dbo.QUANLYKHO.SLSP FROM dbo.QUANLYKHO, dbo.DONHANG WHERE MACN = (SELECT MIN(MACN) FROM dbo.QUANLYKHO WHERE  dbo.QUANLYKHO.MASP = @MASP AND dbo.QUANLYKHO.MADOITAC = dbo.DONHANG.MADOITAC AND dbo.QUANLYKHO.SLSP > @SOLUONG)
...
--delete ghinhan where masp = 'SP0000000001' and madh = 'HD0000000002'
EXEC dbo.INSERT_GHINHAN1 @MADH = 'HD0000000003',  -- char(12)
